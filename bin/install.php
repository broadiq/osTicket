...
$db_installed = false;
echo "Connecting to database mysql://${vars['dbuser']}@${vars['dbhostport']}/${vars['dbname']}\n";
if (!db_connect($vars['dbhostport'],$vars['dbuser'],$vars['dbpass']))
...
$configFile= str_replace('%CONFIG-DBHOST',$vars['dbhostport'],$configFile);
